...
- 2024-03-25: 4690번 완전 세제곱, 9094번 수학적 호기심, 20410번 추첨상 사수 대작전! (Easy), 2231번 분해합 (C++ -> JAVA 재풀이), 2309번 일곱 난쟁이 (재풀이), 2386번 도비의 영어 공부, 2798번 블랙잭 (재풀이), 2858번 기숙사 바닥, 2966번 찍기, 30089번 새로운 문자열 만들기 (재풀이)
---
